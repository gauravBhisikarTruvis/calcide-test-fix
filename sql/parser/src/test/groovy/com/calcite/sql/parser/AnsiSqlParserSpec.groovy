...
class AnsiSqlParserSpec extends SqlParserSpec {
  ...
  SqlParseFixture parse(String sql) {
    new AnsiSqlParseFixture(sql)
  }

  class AnsiSqlParseFixture extends SqlParserSpec.SqlParseFixture {
    private final AnsiSqlParser parser = new AnsiSqlParser()

    AnsiSqlParseFixture(String sql) {
      super(sql)
    }
