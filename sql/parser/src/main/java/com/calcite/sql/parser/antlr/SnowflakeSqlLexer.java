...
public class SnowflakeSqlLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__57", "ABS", "ACOS", "ACOSH", "ALL", "AND", "ANY", "APPROXIMATE", 
			"AS", "ASC", "ASIN", "ASINH", "AT", "ATAN", "ATAN2", "ATANH", "AVG", 
			"BETWEEN", "BOTH", "BY", "CASE", "CAST", "CEIL", "CEILING", "COALESCE", 
			"COLLATE", "CONVERT_TIMEZONE", "COS", "COSH", "COUNT", "CROSS", "CUBE", 
			"CURRENT", "CURRENT_DATE", "CURRENT_TIME", "CURRENT_TIMESTAMP", "CURRENT_USER", 
			"DATEADD", "DATEDIFF", "DESC", "DISTINCT", "ELSE", "END", "ESCAPE", "EXCEPT", 
			"EXCLUDE", "EXISTS", "EXTRACT", "FIRST", "FLATTEN", "FLOOR", "FOLLOWING", 
			"FOR", "FROM", "FULL", "GROUP", "GROUPING", "HAVING", "IF", "ILIKE", 
			"IN", "INNER", "INTERSECT", "INTERVAL", "IS", "JOIN", "LAST", "LATERAL", 
			"LEADING", "LEFT", "LIKE", "LIMIT", "LISTAGG", "LOCALTIME", "LOCALTIMESTAMP", 
			"LOG", "MAX", "MIN", "MOD", "NATURAL", "NOT", "NULL", "NULLS", "OBJECT_AGG", 
			"OFFSET", "ON", "OR", "ORDER", "OUTER", "OVER", "PARTITION", "PERCENT", 
			"POSITION", "PRECEDING", "QUALIFY", "RANGE", "RECURSIVE", "REGEXP", "RIGHT", 
			"RLIKE", "ROLLUP", "ROW", "ROWS", "SELECT", "SETS", "SIMILAR", "SOME", 
			"STDDEV", "SUBSTRING", "SUM", "TABLE", "THEN", "TIME", "TIMESTAMP", "TO", 
			"TRAILING", "TRIM", "TRY_CAST", "UNBOUNDED", "UNION", "USING", "VARIANCE", 
			"WHEN", "WHERE", "WINDOW", "WITH", "WITHIN", "ZONE", "ARRAY_AGG", "IDENTIFIER", 
			"QUOTED_IDENTIFIER", "INTEGER_LITERAL", "DECIMAL_LITERAL", "STRING_LITERAL", 
			"BINARY_LITERAL", "BOOLEAN_LITERAL", "DATE_LITERAL", "TIME_LITERAL", 
			"TIMESTAMP_LITERAL", "INTERVAL_LITERAL", "VARIANT_LITERAL", "EXPONENT", 
	...
	public SnowflakeSqlLexer(CharStream input) {
		super(input);
